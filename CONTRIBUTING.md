...
> [!IMPORTANT]
> **重要: プルリクエストについて / IMPORTANT: No Pull Requests**
>
> **本リポジトリではプルリクエスト（Pull Requests）を受け付けておりません。** フィードバックは **Issues** を通じて行ってください。
>
...
## 投稿に関するライセンス許諾 / License Grant for Submissions

**Issues に投稿した時点で、あなたは以下の条件に同意したものとみなされます。**
...
1. **著作権ライセンス / Copyright License**
   ...
   You grant RIST (including its successors) an **irrevocable, perpetual, worldwide, royalty‑free, non‑exclusive** license to your submission. This license includes, without limitation, reproduction, modification, adaptation, translation, combination with other works, distribution (including public transmission), public performance and display, creation of derivative works, sublicensing, and any and all other forms of use permitted by applicable law.

2. **特許ライセンス / Patent License**

   あなたは、あなたの投稿に含まれる、または投稿の利用に際して必然的に侵害される特許請求項について、RIST（その承継人を含む）に対し **非独占的・世界包括的・ロイヤリティ無償・取消不能** の特許ライセンスを付与します。このライセンスには、当該発明のいかなる実装についても **製造（make）、使用（use）、販売（sell）、販売の申出（offer for sale）、輸入（import）** を行う権利が含まれます。

   You grant RIST (including its successors) a **non‑exclusive, worldwide, royalty‑free, and irrevocable** patent license under any patent claims that are included in your submission or that are necessarily infringed by the use of your submission. This license permits RIST (including its successors) to **make, use, sell, offer for sale, and import** implementations of such inventions. You also permit RIST (including its successors), to the extent necessary for using your submission, to **modify your submission, create derivative works based on it, and incorporate your submission into new materials**.
...
4. **対価請求の不行使 / No Compensation**
   ...
   当該ライセンスに基づく利用について、あなたは対価・使用料を一切請求しません。
...
5. **採用保証なし / No Obligation to Use**
   ...
   RIST (including its successors) is not obliged to adopt, apply, or incorporate any submission.

---

## 表明保証 / Representations & Warranties

投稿に際し、あなたは以下を **表明・保証** します:
...
2. **第三者権利の不侵害 / No Infringement**
   ...
   著作権、特許、商標、営業秘密、プライバシー等の第三者権利を **侵害していません**。

   The submission **does not infringe** any third‑party rights (including copyright, patent, trademark, trade secrets, privacy rights).

3. **雇用主の許可 / Employer Permission**

   業務として、または雇用主を代表して投稿する場合、必要な許可を得ています。
...
## 受付方針 / Contribution Policy

リソースの完全性とライセンス管理のため、**プルリクエストは受け付けません**。提案・修正・バグ報告は **Issues** を利用してください。  
...
- **改良提案:** 問題点・提案内容・期待効果を具体的に記載してください。公共性を考慮してください。
  ...
  **Improvements**: Describe the issue, proposed enhancement, and expected benefits. Consider public accessibility.

---

## 免責・責任制限 / Disclaimer & Limitation of Liability

RIST（その承継人を含む）が、**Issue** 投稿を利用することに起因して生じたいかなる損害（間接・付随・特別・派生的損害を含む）についても、RIST（その承継人を含む）は法令で認められる範囲で責任を負いません。投稿者は、**Issue** 投稿に起因して生じるいかなる請求・損害・損失等についても責任を負い、RIST（その承継人を含む）に損害が及ばないよう補償するものとします。

To the extent permitted by applicable law, RIST (including its successors) shall not be liable for any damages arising from or related to the use by RIST (including its successors) of your **Issue** submission, including but not limited to indirect, incidental, special, or consequential damages. You agree to indemnify, defend, and hold RIST (including its successors) harmless from any claims, damages, losses, or expenses arising directly from your **Issue** submission itself, including any infringement of third‑party rights or any violation of applicable law.
...
## 言語の優先 / Language Priority

本ドキュメントの日本語版と英語版に不一致がある場合 **日本語版が優先** します。

In the event of any inconsistency between the Japanese and English versions of this document, **the Japanese version shall prevail**.
...
**Issues** に投稿できない内容のお問い合わせ等は、ヘルプデスク「helpdesk[-at-]hpci-office.jp（[-at-]は@にしてください）」にメールにてご連絡ください。

For questions or matters containing confidential information that cannot be posted on the **Issues**, please contact the Helpdesk [ helpdesk[-at-]hpci-office.jp (Please replace "[-at-]" with "@") ].

**最終更新日 / Last Updated**: 2026‑09‑11
